...
<jsp:include page="layout/header.jsp" />
		...
		<h6>
			...
			<li class="list-group-item"><a href="/jakarta-ee9-webapp-cdi-jpa/products.html">Products</a></li>
			<li class="list-group-item"><a href="/jakarta-ee9-webapp-cdi-jpa/login.jsp">Login</a></li>
			<li class="list-group-item"><a href="/jakarta-ee9-webapp-cdi-jpa/logout">Logout</a></li>
			<li class="list-group-item"><a href="/jakarta-ee9-webapp-cdi-jpa/cart/view">View Cart</a></li>
			</ul> 
		</h6>
	</body>
</html>
