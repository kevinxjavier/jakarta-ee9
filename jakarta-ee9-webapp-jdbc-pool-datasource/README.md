...
```
	$ mkdir jakarta-ee9-webapp-jdbc-pool-datasource/src/main/webapp/META-INF/context.xml
	...
	$ mkdir jakarta-ee9-webapp-jdbc-pool-datasource/src/main/webapp/WEB-INF/web.xml
		<resource-ref>
...
```
	...
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/login.html
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/logout
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/products.html		"redirect to list.jsp"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/cart/add
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/cart/view 			"redirect to cart.jsp"

	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/form.jsp    		"error first invoke /product/form the next link"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/product/form		"Securized with LoginFilter"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/product/form?id=1	"Securized with LoginFilter"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-jdbc-pool-datasource/product/delete?id=1
```
