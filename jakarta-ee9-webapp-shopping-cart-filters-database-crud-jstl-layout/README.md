...
```
	...
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/login.html
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/logout
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/products.html 		"redirect to list.jsp"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/cart/add
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/cart/view 			"redirect to cart.jsp"

	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/form.jsp    		"error first invoke /product/form the next link"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/product/form		"Securized with LoginFilter"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/product/form?id=1	"Securized with LoginFilter"
	$ curl http://kevin.cx:9000/jakarta-ee9-webapp-shopping-cart-filters-database-crud-jstl-layout/product/delete?id=1
```
